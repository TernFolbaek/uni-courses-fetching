...
const filePath = 'facultyOfHumanities.html';
...
if (uniqueCourses.length === 0) {
    ...
    try {
        fs.writeFileSync('facultyOfHumanities.json', jsonOutput, 'utf-8');
        console.log("JSON file created successfully: facultyOfHumanities.json");
    } catch (error) {
