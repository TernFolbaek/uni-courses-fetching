...
const filePath = 'facultyOfSocialSciences.html';
...
if (uniqueCourses.length === 0) {
    ...
    try {
        fs.writeFileSync('facultyOfSocialSciences.json', jsonOutput, 'utf-8');
        console.log("JSON file created successfully: facultyOfSocialSciences.json");
    } catch (error) {
