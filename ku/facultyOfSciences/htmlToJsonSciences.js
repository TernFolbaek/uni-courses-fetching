...
const filePath = 'facultyOfSciences.html';
...
if (uniqueCourses.length === 0) {
    ...
    try {
        fs.writeFileSync('facultyOfSciences.json', jsonOutput, 'utf-8');
        console.log("JSON file created successfully: facultyOfSciences.json");
    } catch (error) {
