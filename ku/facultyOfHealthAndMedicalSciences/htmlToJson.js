...
const filePath = 'facultyOfHealth.html';
...
if (uniqueCourses.length === 0) {
    ...
    try {
        fs.writeFileSync('facultyOfHealthAndMedicalSciences.json', jsonOutput, 'utf-8');
        console.log("JSON file created successfully: facultyOfHealthAndMedicalSciences.json");
    } catch (error) {
